...
public class RrdGraphDef implements RrdGraphConstants {
    ...
    public void area(String srcName, Paint color, String legend) {
        area(RrdGraphConstants.DEFAULT_Y_AXIS, srcName, color, legend);
    }
    public void area(int yAxis, String srcName, Paint color, String legend) {
        if (legend != null) {
            comments.add(new LegendText(color, legend));
        }
        addPlotElement(yAxis, new Area(srcName, color));
    }
